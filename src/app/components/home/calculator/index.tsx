        ...
        <div className="max-w-37.5 px-0 mb-8 md:mb-0" data-aos="fade-right">
          ...
          <div data-aos="fade-up">
            <Link
              ...
              className="text-xl bg-primary py-3 px-8 text-white rounded-lg me-3 mb-2 border border-primary hover:bg-secondary"
            >
              Buy House
            </Link>
            <Link
          ...
          <div className="bg-primary rounded-t-lg p-16 w-full">
            ...
            <div className="flex justify-between text-sm text-white mt-2 font-bold">
              ...
              <p>$400K</p>
                      ...
                      <div className="p-4 bg-secondary text-white text-xl rounded-b-lg">
