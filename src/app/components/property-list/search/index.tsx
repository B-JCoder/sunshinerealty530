            ...
            <section className='dark:bg-darkmode px-4'>
                <div className='lg:max-w-screen-xl max-w-screen-md mx-auto'>
                    <div className='flex lg:hidden justify-between items-center mb-4'>
                        ...
                        <button onClick={toggleOffCanvas} className='bg-primary mr-4 text-white py-3 px-6 text-base rounded-lg'>
                        ...
                        <div className='absolute top-0 right-0 w-3/4 max-w-xs bg-white dark:bg-semidark shadow-lg h-full'>
                            <div className='py-14 px-8'>
                                ...
                                <div className='flex flex-col gap-6'>
                                    ...
                                    {/* Example button */}
                                    <div>
                                        <button className='bg-primary text-white w-full py-3 px-6 text-base rounded-lg'>
                                            Find Property
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div className='hidden lg:block lg:col-span-4'>
                            <div className='py-14 px-8 bg-white dark:bg-semidark shadow-property rounded-lg'>
                                ...
                                <div className='flex flex-col gap-6'>
                                    ...
                                    {/* Example button */}
                                    <div>
                                        <button className='bg-primary hover:bg-secondary text-white w-full py-3 px-6 text-base rounded-lg'>
                                            Find Property
                                        </button>
                                    </div>
                                </div>
